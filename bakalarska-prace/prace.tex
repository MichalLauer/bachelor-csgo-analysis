...
% Typ práce
\def\TypPrace{BAKALÁŘSKÁ PRÁCEE}
...
Ten je vyhodnocen pomocí již zmínených statistik. Na konci práce je zhodnocení výsledných predikcí. Nachází se zde i zamyšlení nad použitím modelu v reálném životě a jeho možná vylepšení v budoucnu.
}
