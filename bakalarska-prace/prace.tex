...
které jsou následně použity k výsledné predikci. Dále se zde nachází popis prediktorů pomocí grafů a slovní interpretace. V závěru je zde sestaven multivariabilní logistický regresní model, který předpovídá výsledek zápasů
pro určitý team. Ten je vyhodnocen pomocí již zmínených statistik. Na konci práce je zhodnocení výsledných predikcí. Nachází se zde i zamyšlení nad použitím modelu v reálném životě a jeho možná vylepšení v budoucnu.
}
