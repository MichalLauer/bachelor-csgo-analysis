...
Regresní model jde tedy zapsat dvěma způsoby \cite{Kleinbaum2010}. První způsob, tzn. \uv{Logitový zápis}, používá spojovací funkci společně s pravděpodobností $P(X)$ která značí, se událost stala.
