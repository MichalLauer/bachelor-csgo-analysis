...
tohoto světa proniknout. Větší zájem o esport přinesl i větší tržby herním studiím, která začala do esportových turnajů
{\color{red}
více investovat \cite{Professeur2021}, \cite{liquipedia2021}.
}
...
Hra je z žánru \ac{FPS} a hraje se primárně online proti skutečným hráčům. Counter-Strike se v herní komunitě rychle rozrostl díky své jednoduchosti.
...
{\color{red}
jelikož se tento formát za posledních 20 let nijak extrémně nezměnil.
}
...
{\color{red}
Práce se zaměřuje na identifikování významných prediktorů a následně na vytvoření regresního modelu. Před jakoukoliv prací s daty je ale nutné pochopit, jak se hra vlastně hraje a
...
Zápasy se pak hrají ve formátech \uv{Best of}. Best of 3 například znamená, že se hrají tři mapy.
{\color{red}
