...
get_player_model <- function(.data, .map,
                             .y = "map_winner",
...
save_bc_model(players.models$Vertigo, "vertigo_pro_hrace.tex")

players.models$Vertigo <- 
  get_player_model(.data = data[players.split$Vertigo, ],
                   .map = "Vertigo",
...
players.matrixes$Vertigo <- 
  get_matrix_for_player_model(.model = players.models$Vertigo,
                              .validate = data[-players.split$Vertigo, ])

save_bc_model(players.models$Vertigo, "vertigo_pro_hrace_opt.tex")
```
