...
ggsave(paste0(bc.pictures_dir, "sloupcovy_graf_mtcars.png"), bg = "white",
...
ggsave(paste0(bc.pictures_dir, "histogram_porovnani_mtcars.png"),
  plot = hg, bg = "white",
  width = 140, height = 105, units = "mm"
)
```
...
hg
ggsave(paste0(bc.pictures_dir, "histogram_mtcars_sturges.png"), bg = "white",
       width = 140, height = 105, units = 'mm')
```
...
ggsave(paste0(bc.pictures_dir, "boxplot_mtcars.png"), bg = "white",
       width = 140, height = 105, units = 'mm')
```
...
ggsave(paste0(bc.pictures_dir, "bodovy_graf_mtcars.png"), bg = "white",
       width = 140, height = 105, units = 'mm')
```
...
ggsave(paste0(bc.pictures_dir, "mtcars_korelace.png"), bg = "white",
       width = 140, height = 105, units = 'mm')
```